...
import { formatCurrency, formatPerMile, formatNumber } from '@/components/calculators/shared/formatters';
...
export default function StackedChartCalculator() {
  ...
  const yearlyData = useMemo(() => {
    ...
    if (data.length > 0) {
      data[0]['Diesel Upfront'] = results.diesel.netUpfrontCost;
      data[0]['BEV Upfront'] = results.bev.netUpfrontCost;
      data[0]['Diesel Total'] += results.diesel.netUpfrontCost;
      data[0]['BEV Total'] += results.bev.netUpfrontCost;
    }
